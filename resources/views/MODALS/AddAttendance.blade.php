...
<body>
  <form action="{{ route('AddAttendance') }}" method="POST">
    @csrf
      ...
      <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-600 dark:border-neutral-700 dark:shadow-neutral-700/70">
        ...
        <div class="p-4 md:p-5 flex flex-col gap-10">
          ...
          <div class="max-w-lg">
            ...
            <input type="text" name="name" id="input-label" class="  py-3 px-4 block w-full border-white rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500  disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder" placeholder="Name">
          </div>
          ...
          <div class="max-w-lg">
            ...
            <input type="date" name="date" id="date-picker" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Date">
          </div>
          ...
          <div class="max-w-lg">
            ...
            <input type="text" name="subject" id="input-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Subject">
          </div>
          ...
          <div class="time-in-out flex flex-row gap-10">
            <div class="max-w-sm">
              <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white" id="text-inputs" >Time in</label>
              <input type="text" name="time_in" id="input-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Time in">
            </div>
        


            <div class="max-w-sm">
              <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white" id="text-inputs" >Time out</label>
              <input type="text" name="time_out" id="input-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Time out">
            </div>
          </div>
          ...
          <div class="max-w-lg">
            ...
            <select id="input-label" name="status" class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
